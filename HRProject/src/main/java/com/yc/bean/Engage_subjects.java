...
public class Engage_subjects implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4738731019232952994L;
	//创建新表 "engage_subjects"。                                                                    */
	//* "engage_subjects" : 试题题库登记表                                                                */
	private int sub_id;// 主键，自动增长列                                                                       */
	private String first_kind_id;//试题I级分类编号                                                                */
	private String first_kind_name;// 试题I级分类名称                                                              */
	private String second_kind_id;//试题II级分类编号                                                              */
	private String second_kind_name;// 试题II级分类名称                                                            */
	private String register;// 登记人                                                                          */
	private Date regist_time;// 登记时间                                                                      */
	private String derivation;// 试题出处                                                                       */
	private String content;// 题干                                                                            */
	private String key_a;// 答案a                                                                             */
	private String key_b;// 答案b                                                                             */
	private String key_c;// 答案c                                                                             */
	private String key_d;// 答案d                                                                             */
	private String key_e;// 答案e                                                                             */
	private String correct_key;//正确答案                                                                      */
