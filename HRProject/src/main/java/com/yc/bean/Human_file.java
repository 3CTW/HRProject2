...
public class Human_file implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8887148012876882048L;
	//*创建新表 "human_file"。                                                                         */
//* "human_file" : 人力资源档案                                                                      */
	private int huf_id;// 主键，自动增长列                                                                       */
	...
	private String uman_major_kind_id;// 职位分类编号                                                            */
	...
	private String human_society_security_id;//社会保障号                                                       */
	...
	private int file_chang_amount;// 档案变更累计次数                                                            */
	...
	private boolean human_file_status;/// 档案状态                                                            
	...
	public String getUman_major_kind_id() {
		return uman_major_kind_id;
	}
	public void setUman_major_kind_id(String uman_major_kind_id) {
		this.uman_major_kind_id = uman_major_kind_id;
	}
