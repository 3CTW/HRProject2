...
public class Engage_resume implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7468956588495675519L;
	//创建新表 "engage_resume"。                                                                      */
	//* "engage_resume" : 简历管理                                                                     */
	...
	private BigDecimal demand_salary_standard;//薪酬标准                                                           */
	...
	public BigDecimal getDemand_salary_standard() {
		return demand_salary_standard;
	}
	public void setDemand_salary_standard(BigDecimal demand_salary_standard) {
