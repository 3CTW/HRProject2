...
<style>
    ...
    <p>您正在做的业务是：人力资源--薪酬标准管理--薪酬标准复核</p>
	...
	<input  type="button" value="查询" />
		...
		<thead>
			<tr>
				...
				<th field="复核意见"  sortable="true">复核意见</th>
			 <th colspan="7"><input type="text" style="width:700px; height:60px;"value=""/></th>
			</tr><tr>
