...
alter table users change u_true_nam u_true_name varchar(60) not null;
...
create table config_file_first_kind( 
	ffk_id smallint primary key auto_increment,
	first_kind_id varchar(20) ,
	first_kind_name varchar(100) ,
...
create table config_file_second_kind ( 
	fsk_id smallint primary key auto_increment,
	first_kind_id varchar(20) ,
...
create table config_file_third_kind ( 
	ftk_id smallint primary key auto_increment,
...
create table config_question_first_kind ( 
	qfk_id smallint primary key auto_increment,
	first_kind_id char(2) ,
	first_kind_name varchar(60) );  
...
create table config_question_second_kind ( 
	qsk_id smallint primary key auto_increment,
	first_kind_id char(2) ,
	first_kind_name varchar(60) ,
	second_kind_id char(2) ,
	second_kind_name varchar(60) );  
...
create table config_primary_key ( 
	prk_id smallint primary key auto_increment,
...
create table config_major ( 
	mak_id smallint primary key auto_increment,
	major_kind_id char(2) ,
	major_kind_name varchar(60) ,
	major_id char(2),
...
create table human_file_dig ( 
	hfd_id smallint primary key auto_increment,
	human_id varchar(30) ,
	first_kind_id char(2) ,
	first_kind_name varchar(60) ,
	second_kind_id char(2) ,
	...
	salary_sum double ,
	demand_salaray_sum double ,
	paid_salary_sum double ,
...
create table human_file ( 
	huf_id smallint primary key auto_increment,
	human_id varchar(30) ,
	first_kind_id char(2) ,
	first_kind_name varchar(60) ,
	second_kind_id char(2) ,
	...
	salary_standard_id varchar(30) ,
	salary_standard_name varchar(60) ,
	salary_sum decimal(12,2) ,
	demand_salaray_sum decimal(12,2) ,
	paid_salary_sum decimal(12,2) ,
	major_change_amount smallint ,
	bonus_amount smallint ,
	training_amount smallint ,
	file_chang_amount smallint ,
...
create table salary_standard_details ( 
	sdt_id smallint primary key auto_increment,
...
create table salary_standard ( 
	ssd_id smallint primary key auto_increment,
	standard_id varchar(30) ,
	standard_name varchar(60) ,
	designer varchar(60) ,
	register varchar(60) ,
...
/* 	"check_status" : 复核状态                                                                     */  
create table bonus ( 
	bon_id smallint primary key auto_increment,
...
create table training ( 
	tra_id smallint primary key auto_increment,
	major_kind_id char(2) null,
	major_kind_name varchar(60) null,
	major_id char(2) null,
	major_name varchar(60) null,
...
create table major_change ( 
	mch_id smallint primary key auto_increment,
	first_kind_id char(2) ,
	first_kind_name varchar(60) ,
	second_kind_id char(2) ,
	second_kind_name varchar(60) ,
...
create table engage_major_release ( 
	mre_id smallint primary key auto_increment,
...
create table engage_exam_details ( 
	exd_id smallint  primary key auto_increment,
...
create table engage_exam ( 
	exa_id smallint primary key auto_increment,
	exam_number varchar(30) null,
	major_kind_id char(2) null,
	major_kind_name varchar(60) null,
	major_id char(2) null,
	...
	/*解决了默认时间的问题*/
insert into engage_exam(exam_number,major_kind_id ,major_kind_name ,major_id ,major_name,register,regist_time ,
limite_time) values('1','1','销售','2','销售专员','兄啊',CURRENT_DATE,60);
...
create table engage_answer( 
	ans_id smallint primary key auto_increment,
...
create table engage_answer_details ( 
	and_id smallint primary key auto_increment,
	answer_number varchar(30) null,
...
create table engage_subjects ( 
	sub_id smallint primary key auto_increment,
	first_kind_id char(2) null,
	first_kind_name varchar(60) null,
	second_kind_id char(2) null,
	second_kind_name varchar(60) null,
	...
	changer varchar(60) null,
	change_time datetime null);  
/*datetime：默认当前系统时间是：CURRENT_DATE
 * timestamp： 默认当前系统时间 timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,但是他的范围小：1970-01-01 00:00:01 ~ 2038 
 * */
insert into engage_subjects(first_kind_id ,first_kind_name ,second_kind_id,second_kind_name,register ,regist_time,derivation ,
	content,key_a ,key_b ,key_c ,key_d ,key_e ,correct_key ,changer ,change_time)
	values('01','销售','02','业务','饿方法v',CURRENT_DATE,'销售部','与人相处','a','b','c','d','e','ac','小花',CURRENT_DATE);
...
create table engage_resume ( 
	res_id smallint  primary key auto_increment,
	human_name varchar(60) null,
...
create table engage_interview ( 
	ein_id smallint primary key auto_increment,
	human_name varchar(60) null,
